...
2. [Install Serbian (Cyrillic) Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Serbian (Cyrillic) language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Serbian (Cyrillic) language pack {#active}
